...
public class Navigator extends AbstractDwcControl implements IStyleable, IThemable, IExpansible {
    ...
    void create(AbstractDwcjPanel p) {
        try {
            ...
            w.addNavigator(w.getAvailableControlID(), BASISNUMBER_1, BASISNUMBER_1, BASISNUMBER_1, BASISNUMBER_1, "");
            catchUp();
        } catch (Exception e)  {
            e.printStackTrace();
        }
