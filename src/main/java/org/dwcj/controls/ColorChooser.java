...
public class ColorChooser extends AbstractDwcControl implements IStyleable, IThemable, IExpansible {
    ...
    @Override
    public ColorChooser addClass(String selector) {
        super.addControlCssClass(selector);
        return this;
    }

    @Override
    public ColorChooser removeClass(String selector) {
