...
public class ProgressBar extends AbstractDwcControl implements IStyleable, IThemable {
    ...
    void create(AbstractDwcjPanel p) {
        try {
            ...
            w.addProgressBar(w.getAvailableControlID(), BASISNUMBER_1, BASISNUMBER_1, BASISNUMBER_1, BASISNUMBER_1);
            catchUp();
        } catch (Exception e)  {
            e.printStackTrace();
        }
