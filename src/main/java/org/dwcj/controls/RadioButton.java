...
public class RadioButton extends AbstractDwcControl implements IStyleable, IExpansible {
    ...
    void create(AbstractDwcjPanel p) {
        try {
            ...
            w.addRadioButton(w.getAvailableControlID(), BASISNUMBER_1, BASISNUMBER_1, BASISNUMBER_1, BASISNUMBER_1, "");
            catchUp();
        } catch (Exception e)  {
            e.printStackTrace();
        }
